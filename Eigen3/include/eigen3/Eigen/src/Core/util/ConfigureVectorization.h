...
// removed as gcc 4.1 and msvc 2008 are not supported anyways.
  ...
  // a user reported that in 64-bit mode, MSVC doesn't care to define _M_IX86_FP.
    ...
    // Disable AVX support on broken xcode versions
      ...
      // NOTE using -macosx-version-min=10.15 with Xcode 11.0 results in runtime segmentation faults in many examples, 11.2 produce core dumps in 3 examples
      // NOTE using -macosx-version-min=10.14 produces functioning and passing examples in all cases
      // NOTE __clang_version__ "11.0.0 (clang-1100.0.33.8)"  XCode 11.0 <- Produces many segfault and core dumping examples
      //                                                                    with  -macosx-version-min=10.15 and AVX
      // NOTE __clang_version__ "11.0.0 (clang-1100.0.33.12)" XCode 11.2 <- Produces 3 core dumping examples with
